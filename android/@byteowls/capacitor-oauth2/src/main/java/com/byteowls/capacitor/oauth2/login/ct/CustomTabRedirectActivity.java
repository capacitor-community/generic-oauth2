 ...
 * the result.
 */
public class CustomTabRedirectActivity extends Activity {
    private static final int CUSTOM_TAB_REDIRECT_REQUEST_CODE = 2;
    public static final String CUSTOM_TAB_REDIRECT_ACTION =
            CustomTabRedirectActivity.class.getSimpleName() + ".action_customTabRedirect";
    public static final String DESTROY_ACTION =
            CustomTabRedirectActivity.class.getSimpleName() + ".action_destroy";
        ...
        if (resultCode == RESULT_CANCELED) {
            ...
            closeReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    CustomTabRedirectActivity.this.finish();
                }
            };
            LocalBroadcastManager.getInstance(this).registerReceiver(
                    closeReceiver,
                    new IntentFilter(CustomTabRedirectActivity.DESTROY_ACTION)
            );
        }
    }
